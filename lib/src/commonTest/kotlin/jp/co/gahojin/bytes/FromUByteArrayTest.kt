...
class FromUByteArrayTest : FunSpec({
    test("getShort") {
        ...
        checkAll(Arb.int(Short.MIN_VALUE..Short.MAX_VALUE.toInt())) { a ->
            val sut = UByteArray(2)
            sut.putShort(0, a)
    ...
    test("getUShort") {
        ...
        checkAll(Arb.uInt(UShort.MIN_VALUE.toUInt()..UShort.MAX_VALUE.toUInt())) { a ->
            val sut = UByteArray(2)
            sut.putShort(0, a)
    ...
    test("put(Bytes)") {
        checkAll(Arb.uByteArray(Arb.int(10..256), Arb.uByte())) { a ->
